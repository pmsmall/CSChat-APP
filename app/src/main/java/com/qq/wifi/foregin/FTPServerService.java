...
public class FTPServerService extends Service implements Runnable {
    ...
    private void setupNotification() {
        ...
        Notification.Builder nBuilder=new Notification.Builder(getApplicationContext()).setAutoCancel(true).setTicker(tickerText).setWhen(when);

        nBuilder.setContentTitle(contentTitle).setContentText(contentText).setContentIntent(contentIntent);
